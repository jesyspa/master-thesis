...
%format ==R = "\F{$\equiv^R$}"
%format ==eR = "\F{$\equiv_\epsilon^R$}"
%format ==e1R = "\F{$\equiv_{\epsilon_1}^R$}"
%format ==e2R = "\F{$\equiv_{\epsilon_2}^R$}"
%format ==eeR = "\F{$\equiv_{\epsilon_1 + \epsilon_2}^R$}"
%format ==1R = "\F{$\equiv_1^R$}"
