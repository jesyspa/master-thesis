...
We now have a notion of games and a notion of closeness of games, b
...
eavesdropping, but not secure if the adversary can make use of the encryption function.
